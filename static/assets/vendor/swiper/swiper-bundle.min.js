...
var Swiper = (function () {
  ...
  function M(e) {
    return (t) => (Math.abs(t) > 0 && e.browser && e.browser.need3datasetix && Math.abs(t) % 90 == 0 ? t + 0.001 : t);
  }
  let C, P, L;
  function I() {
    return (
      ...
      L ||
        (L = (function () {
          ...
          const i = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(e.navigator.userAgent),
            n = a();
          return { isSafari: s || n, needPerspectiveFix: s, need3datasetix: n || (i && t.ios), isWebView: i };
        })()),
      L
    );
  }
    ...
    if (
      ...
      g > 0
        ? (b &&
            ...
            i.currentTranslate >
              (r.centeredSlides
                ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ('auto' !== r.slidesPerView && s.slides.length - r.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween
                : s.minTranslate()) &&
