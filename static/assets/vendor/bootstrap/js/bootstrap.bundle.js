...
(function (global, factory) {
  ...
  function mapToStyles(_ref2) {
    ...
    if (gpuAcceleration) {
      ...
      return Object.assign(
        ...
        (_Object$assign.transform = (win.devicePixelRatio || 1) <= 1 ? 'translate(' + x + 'px, ' + y + 'px)' : 'translate3d(' + x + 'px, ' + y + 'px, 0)'),
        _Object$assign)
      );
    }
  ...
  */
  ...
  function getExpandedatasetallbackPlacements(placement) {
  ...
  function flip(_ref) {
    ...
    var _options$mainAxis = options.mainAxis,
      ...
      specifiedatasetallbackPlacements = options.fallbackPlacements,
    ...
    var fallbackPlacements = specifiedatasetallbackPlacements || (isBasePlacement || !flipVariations ? [getOppositePlacement(preferredPlacement)] : getExpandedatasetallbackPlacements(preferredPlacement));
